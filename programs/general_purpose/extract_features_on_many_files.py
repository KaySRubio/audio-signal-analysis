...
#    python -m programs.general_purpose.extract_features_on_many_files --csvfile metadata_clean_short.csv
...
if __name__ == '__main__':
  ...
  for _, row in df.iterrows():
      ...
      result = subprocess.run(
        ['python', '-m', 'mic_bump_detector_programs.feature_extraction',
